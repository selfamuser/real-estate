...
function Listing() {
    ...
    return (
        <main>
            {loading && <p className='text-center my-7 text-purple-700 text-2xl'>Loading...</p>}
            {error && (
                <p className='text-center my-7 text-purple-700 text-2xl'>Something went wrong!!!!</p>
            )}
                    ...
                    <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
                        ...
                        <ul className='text-green-900 font-semibold text-sm flex flex-wrap items-center gap-4 sm:gap-6'>
                            ...
                            <li className='flex items-center gap-1 whitespace-nowrap '>
                                ...
                                {listing.bathrooms > 1
                                    ? `${listing.bathrooms} Washrooms `
                                    : `${listing.bathrooms} Washroom `}
                            </li>
                            <li className='flex items-center gap-1 whitespace-nowrap '>
